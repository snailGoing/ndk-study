#include <unistd.h>
#include <fmod.hpp>
#include "com_personal_qvoice_MainActivity.h"
...
extern "C" JNIEXPORT void JNICALL Java_com_personal_qvoice_MainActivity_voiceChangeNative
    ...
    // TODO 第五步：增加特效
    switch (mode) {
        case com_personal_qvoice_MainActivity_MODE_NORMAL: // 原生
            content_ = "原生 播放完毕";
            break;
        case com_personal_qvoice_MainActivity_MODE_LUOLI: // 萝莉
            content_ = "萝莉 播放完毕";
            ...
            break;
        case com_personal_qvoice_MainActivity_MODE_DASHU: // 大叔
            content_ = "大叔 播放完毕";
            ...
            channel->addDSP(0, dsp);
            break;
        case com_personal_qvoice_MainActivity_MODE_GAOGUAI: // 搞怪
            ...
            break;
        case com_personal_qvoice_MainActivity_MODE_JINGSONG: // 惊悚
            content_ = "惊悚 播放完毕";
            ...
            // 调音师：才能跳出来  同学们自己去调
            break;
        case com_personal_qvoice_MainActivity_MODE_KONGLING: // 空灵  学校广播
            content_ = "空灵 播放完毕";
